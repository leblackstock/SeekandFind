...
# Book 1 Promo Image 04 - Sparkle Market Token Teaser

Create one image now.

Image type: promotional art for an Ember children's seek-and-find book.
Use case: character intro post and profile-friendly promo image.
...
Exact text to render: Find the Sparkle Market Token
