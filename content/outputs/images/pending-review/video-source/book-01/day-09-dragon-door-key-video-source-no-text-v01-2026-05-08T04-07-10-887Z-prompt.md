...
Remove all readable text from the reference. The reference includes: "Can you find the Dragon Door Key?". Remove the text completely.
...
Campaign concept: Dragon Door Key in a cozy, child-friendly seek-and-find world with lanterns, tiny treasures, and one curious baby dragon.
