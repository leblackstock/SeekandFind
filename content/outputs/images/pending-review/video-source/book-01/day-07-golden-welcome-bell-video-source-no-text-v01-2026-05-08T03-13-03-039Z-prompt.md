...
Remove all readable text from the reference. The reference includes: "Can you find the Golden Welcome Bell?". Remove the text completely.
...
Campaign concept: Golden Welcome Bell in a cozy, child-friendly seek-and-find world with lanterns, tiny treasures, and one curious baby dragon.
