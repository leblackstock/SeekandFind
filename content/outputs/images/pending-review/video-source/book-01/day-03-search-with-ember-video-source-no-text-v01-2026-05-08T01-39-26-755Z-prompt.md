...
Remove all readable text from the reference. The reference includes: "Search with Ember!". Remove the text completely.
...
Campaign context:
Lanterns, tiny treasures, and one curious baby dragon. Ember’s world is built for little seekers.
