...
Remove all readable text from the reference. The reference includes: "Can you help Ember find it?". Remove the text completely.
...
Campaign concept: Lantern Maker Workshop in a cozy, child-friendly seek-and-find world with lanterns, tiny treasures, and one curious baby dragon.
