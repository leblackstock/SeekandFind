...
Remove all readable text from the reference. The reference includes: "Find the Firefly Flower Charm". Remove the text completely.
...
Campaign concept: Firefly Flower Charm in a cozy, child-friendly seek-and-find world with lanterns, tiny treasures, and one curious baby dragon.
