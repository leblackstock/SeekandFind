...
# day-11-ember-progress-note End Frame Prompt

Campaign: Book 1 Prelaunch Rolling Campaign
Campaign day: Day 11
Task: `book01-day11-short-video-tiktok-youtube-shorts-instagram-reels-facebook-reels`
...
`content/outputs/images/approved/video-source/book-01/day-11-ember-progress-note-video-source-no-text-v01-2026-05-08T05-54-04-371Z.png`

Start frame:

`content/outputs/videos/batches/book-01-short-video-batch-2026-05-08/start-end-frames/day-11-ember-progress-note/day-11-ember-progress-note-start-frame.png`

Expected end-frame save path:

`content/outputs/images/pending-review/start-end-frames/book-01/day-11-ember-progress-note/day-11-ember-progress-note-end-frame-v01.png`

Caption context:

The seek-page and story/list workflow is working, and Ember's first book world is getting closer one approved asset at a time.
