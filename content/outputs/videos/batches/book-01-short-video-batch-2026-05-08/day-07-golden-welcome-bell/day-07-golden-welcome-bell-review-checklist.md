# day-07-golden-welcome-bell Review Checklist
...
Expected queue status before approved export: `needs-video-export`

## Image Preflight

- [ ] Preflight branch recorded as C.
- [ ] Exact visible text recorded: `Can you find the Golden Welcome Bell?`.
