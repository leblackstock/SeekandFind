...
Remove all readable text from the reference. The reference includes: "Meet Ember", "Your baby dragon guide". Remove the text completely.
...
Campaign concept: Ember Progress Note in a cozy, child-friendly seek-and-find world with lanterns, tiny treasures, and one curious baby dragon.
