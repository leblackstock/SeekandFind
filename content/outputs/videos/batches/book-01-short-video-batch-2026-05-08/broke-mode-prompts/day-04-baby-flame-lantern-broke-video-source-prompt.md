...
Remove all readable text from the reference. The reference includes: "Can you find the Baby Flame Lantern?". Remove the text completely.
...
Campaign concept: Baby Flame Lantern in a cozy, child-friendly seek-and-find world with lanterns, tiny treasures, and one curious baby dragon.
