...
Remove all readable text from the reference. The reference includes: "Find the tiny treasure". Remove the text completely.
...
Campaign concept: Cozy Dragon Village in a cozy, child-friendly seek-and-find world with lanterns, tiny treasures, and one curious baby dragon.
