# day-11-ember-progress-note Video-Source Image Prompt
...
Preserve Ember, the warm Sparkleflame Festival mood, the core marketing concept, the cozy lantern-lit colors, and the general composition implied by the reference/caption. The reference image contains readable text: "Meet Ember", "Your baby dragon guide". Remove that text completely.
