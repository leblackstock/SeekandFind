# day-04-baby-flame-lantern Start/End Frame Review Checklist
...
- [ ] Recorded motion object is used: overhead lanterns.
- [ ] Specific motion instruction is followed: Animate only the lanterns up top as the chosen scene-object motion: a slow gentle sway and a soft warm glow pulse across the hanging lanterns. The Dragon Flame Lantern on the shelf briefly glows brighter for a moment while staying fixed in place. The table lantern remains still.
