# day-04-baby-flame-lantern Keyframe Image-To-Video Prompt
...
2. Upload approved end frame:
   `content/outputs/images/approved/start-end-frames/book-01/day-04-baby-flame-lantern/day-04-baby-flame-lantern-end-frame-v01.png`
...
Chosen scene-object motion: overhead lanterns.
Specific motion: Animate only the lanterns up top as the chosen scene-object motion: a slow gentle sway and a soft warm glow pulse across the hanging lanterns. The Dragon Flame Lantern on the shelf briefly glows brighter for a moment while staying fixed in place. The table lantern remains still.
