# day-10-sparkle-market-token Start/End Frame Review Checklist
...
- [ ] Recorded motion object is used: bell.
- [ ] Specific motion instruction is followed: Animate one separate market bell: a small single swing and return with a soft shimmer or jingle feel. The Sparkle Market Token plus Ember-held and Ember-worn items remain outside the chosen object motion.
