...
Owner-approved chosen motion object for this video: ribbon. Use that as the single chosen scene-object motion; do not substitute an Ember-held or Ember-attached item as the chosen object motion.
