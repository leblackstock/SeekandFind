# day-12-cozy-seek-and-find-adventure Start/End Frame Review Checklist
...
- [ ] Recorded motion object is used: string banners & lanterns.
- [ ] Specific motion instruction is followed: Animate the overhead string banners and lanterns together as one connected scene-object motion: banners flutter lightly while lanterns sway a few degrees and glow softly.
