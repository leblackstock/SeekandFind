# day-09-dragon-door-key Keyframe Image-To-Video Prompt
...
2. Upload approved end frame:
   `content/outputs/images/approved/start-end-frames/book-01/day-09-dragon-door-key/day-09-dragon-door-key-end-frame-v01.png`
...
Specific motion: Animate a separate decorative ribbon near the dragon-door scene, distinct from the Dragon Door Key and Ember's scarf: it ripples gently from one end to the other with a small breeze while staying tied or anchored.
