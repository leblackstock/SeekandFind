# day-05-lantern-maker-workshop Keyframe Image-To-Video Prompt
...
2. Upload approved end frame:
   `content/outputs/images/approved/start-end-frames/book-01/day-05-lantern-maker-workshop/day-05-lantern-maker-workshop-end-frame-v01.png`
...
Chosen scene-object motion: loose teal ribbon on the worktable.
Specific motion: Animate only the loose teal ribbon on the worktable: one tiny ripple travels along the free end with a barely visible edge flutter while the ribbon stays touching the table. The tools and mission item remain still.
