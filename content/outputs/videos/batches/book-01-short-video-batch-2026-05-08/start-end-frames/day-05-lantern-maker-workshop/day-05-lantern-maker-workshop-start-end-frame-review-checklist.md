# day-05-lantern-maker-workshop Start/End Frame Review Checklist
...
- [ ] Recorded motion object is used: loose teal ribbon on the worktable.
- [ ] Specific motion instruction is followed: Animate only the loose teal ribbon on the worktable: one tiny ripple travels along the free end with a barely visible edge flutter while the ribbon stays touching the table. The tools and mission item remain still.
