# day-11-ember-progress-note Keyframe Image-To-Video Prompt
...
2. Upload approved end frame:
   `content/outputs/images/approved/start-end-frames/book-01/day-11-ember-progress-note/day-11-ember-progress-note-end-frame-v01.png`
...
Chosen scene-object motion: string lights/lanterns.
Specific motion: Animate only the overhead string lights and lanterns: a soft warm twinkle traveling slowly along the string plus a barely visible sway. Notes and paper content remain visually static.
