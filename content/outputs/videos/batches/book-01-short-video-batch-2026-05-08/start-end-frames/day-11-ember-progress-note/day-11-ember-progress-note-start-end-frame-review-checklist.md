# day-11-ember-progress-note Start/End Frame Review Checklist
...
- [ ] Recorded motion object is used: string lights/lanterns.
- [ ] Specific motion instruction is followed: Animate only the overhead string lights and lanterns: a soft warm twinkle traveling slowly along the string plus a barely visible sway. Notes and paper content remain visually static.
