# day-08-firefly-flower-charm Keyframe Image-To-Video Prompt
...
2. Upload approved end frame:
   `content/outputs/images/approved/start-end-frames/book-01/day-08-firefly-flower-charm/day-08-firefly-flower-charm-end-frame-v01.png`
...
Chosen scene-object motion: blue and purple lanterns.
Specific motion: Animate the blue and purple hanging lanterns: alternate a very soft glow pulse with a slow synchronized sway while their positions remain recognizable. The Firefly Flower Charm mission item remains still.
