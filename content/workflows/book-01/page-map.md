...
Source mirror: active Ember Book 1 plan in the consolidated rules bundle.

This file is the automation working page map for `ember-content-studio`. Update it from the four-file rules bundle when the canonical page map changes.
